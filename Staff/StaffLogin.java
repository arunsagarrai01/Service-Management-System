...
public class StaffLogin extends Application {
    ...
    public void openStaffPanel(Stage primaryStage) {
        ...
        // Action for User Management button sets

        Button btnServiceManagement = new Button("Service Management");
        // Action for Service Management button sets

        Button btnAppointmentManagement = new Button("Appointment Management");
        // Action for Appointment management button sets
        ...
        newPane.add(btnUserManagement, 0, 0);//Row and column sets of User Management
        newPane.add(btnServiceManagement, 0, 1);// Row and column sets of Service Management
        newPane.add(btnAppointmentManagement, 0, 2);// Row and column sets of Appointment Management
