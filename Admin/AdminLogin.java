...
public class AdminLogin extends Application {
    ...
    public void openAdminPanel(Stage primaryStage) {//New openAdminPanel created
        ...
        newPane.add(btnUserManagement, 0, 0);//User management button row and column sets
        newPane.add(btnServiceManagement, 0, 1); // Service management button row and column sets
        newPane.add(btnAppointmentManagement, 0, 2); // Appoinment management button row and column sets
